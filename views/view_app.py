...
from .widgets.inputs import InputsScreen
from .create_cv import CreateCvScreen
from .table_cv import TableScreen
...
class ViewApp(App):
    ...
    MODES = {
        "create_cv": CreateCvScreen,
        "home": HomeScreen,
        "dynamic_inputs": TableScreen,
    }
    DEFAULT_MODE = "home"
    BINDINGS = [
        Binding(
        ...
        Binding(
            "ctrl+t",
            "app.switch_mode('dynamic_inputs')",
            "Ver CVS",
            tooltip="Show the home dynamic inputs",
        ),
        Binding(
            "ctrl+n",
            "app.switch_mode('create_cv')",
            "Crear CV",
            tooltip="crea una nueva cv",
        ),
        Binding(
            "ctrl+s",
            "app.screenshot",
